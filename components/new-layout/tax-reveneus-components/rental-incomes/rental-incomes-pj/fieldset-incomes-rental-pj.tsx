...
import RentalIncomesPJ from './rental-incomes-pj';

export default function FieldsetIncomesPJ() {
            ...
            <form id="msform">
              ...
              <fieldset>
                ...
                <button
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    router.push('/2021/arrecadacao/aluguel-pf');
                  }}
                >
                  Voltar
                </button>
                <button
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    router.push('/2021/arrecadacao/aposentadoria');
                  }}
                >
                  Continuar
                </button>

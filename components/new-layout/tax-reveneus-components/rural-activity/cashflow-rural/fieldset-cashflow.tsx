...
import CashFlowRural from './cashflow-rural';

export default function FieldsetCashflowRural() {
        ...
        <div className="row justify-content-center my-auto">
          <div className="col-lg-8 my-5 text-center nucelo-full">
            <form id="msform">
              ...
              <fieldset>
                <h3>Fluxo de Caixa Atividade Rural</h3>
                ...
                <button
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    router.push('/2021/arrecadacao/empresa-propria');
                  }}
                >
                  Voltar
                </button>

...
import FormDonationReceived from '../../../components/new-layout/tax-reveneus-components/donations/form-donation-received';

function DonationReceivedPage({ props }: AuthProps) {
  ...
  return (
    <DefaultThemeNew session={props.session}>
      <div className="main-content">
        <Header />
        <FormDonationReceived />
      </div>
    </DefaultThemeNew>
  );
}

DonationReceivedPage.getInitialProps = getServerSideProps;

...
import InteriorSeveralIncomesForm from '../../../components/new-layout/tax-reveneus-components/several-incomes/interior-several-incomes/interior-several-incomes-form';

function InteriorSeveralIncomesPage({ props }: AuthProps) {
  ...
  return (
    <DefaultThemeNew session={props.session}>
      <div className="main-content">
        <Header />
        <InteriorSeveralIncomesForm session={props.session} />
      </div>
    </DefaultThemeNew>
  );
}

InteriorSeveralIncomesPage.getInitialProps = getServerSideProps;
export default InteriorSeveralIncomesPage;

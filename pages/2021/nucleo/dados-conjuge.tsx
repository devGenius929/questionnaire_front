...
import FormPartnerDataPage from '../../../components/new-layout/personal-form/forms-dependants/form-partner-data';

function PartnerDataPage({ props }: AuthProps) {
...
PartnerDataPage.getInitialProps = getServerSideProps;

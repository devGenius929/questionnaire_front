...
import RescueSocialSecurity from '../../../components/new-layout/tax-reveneus-components/rescue-social-security/rescue-social-security-form';

function RescueSocialSecurityPage({ props }: AuthProps) {
...
RescueSocialSecurityPage.getInitialProps = getServerSideProps;
export default RescueSocialSecurityPage;

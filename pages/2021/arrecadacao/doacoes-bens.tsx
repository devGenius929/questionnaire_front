...
import FormFinancialAssetsReceived from '../../../components/new-layout/tax-reveneus-components/donations/form-financial-assets-received';

function DonationsFinancialAssetsPage({ props }: AuthProps) {
  ...
  return (
    <DefaultThemeNew session={props.session}>
      <div className="main-content">
        <Header />
        <FormFinancialAssetsReceived />
      </div>
    </DefaultThemeNew>
  );
}

DonationsFinancialAssetsPage.getInitialProps = getServerSideProps;
export default DonationsFinancialAssetsPage;

...
import ExteriorSeveralIncomesForm from '../../../components/new-layout/tax-reveneus-components/several-incomes/exterior-several-incomes/exterior-several-incomes-form';

function ExteriorSeveralIncomesPage({ props }: AuthProps) {
  ...
  return (
    <DefaultThemeNew session={props.session}>
      <div className="main-content">
        <Header />
        <ExteriorSeveralIncomesForm session={props.session} />
      </div>
    </DefaultThemeNew>
  );
}

ExteriorSeveralIncomesPage.getInitialProps = getServerSideProps;
export default ExteriorSeveralIncomesPage;

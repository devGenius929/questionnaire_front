...
import IncomesCompany from './incomes-company';

export default function FieldsetAutonomous() {
        ...
        <div className="row justify-content-center my-auto">
          <div className="col-lg-8 my-5 text-center nucelo-full">
            <form id="msform">
              ...
              <fieldset>
                <h3>Autônomo Recebimentos Empresa</h3>
                ...
                <button
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    router.push('/2021/arrecadacao/rendimentos-pf');
                  }}
                >
                  Voltar
                </button>
                <button
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    router.push('/2021/arrecadacao/autonomo-fluxo-de-caixa');
                  }}
                >
                  Continuar
                </button>

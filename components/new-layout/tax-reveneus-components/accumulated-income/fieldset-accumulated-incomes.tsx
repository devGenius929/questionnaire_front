...
import AccumulatedIncomes from './accumulated-incomes';

export default function FieldsetAccumulatedIncomes() {
            ...
            <form id="msform">
              ...
              <fieldset>
                ...
                <button
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    router.push('/2021/arrecadacao/rendimentos-diversos');
                  }}
                >
                  Continuar
                </button>
